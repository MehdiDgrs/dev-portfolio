...
const Headvideo: React.FC = () => {
    ...
    const handleLoading = React.useCallback(()=>{setIsLoading(true)},[]);
    ...
    return (
        <div ref={refContainer}className=" min-h-screen flex flex-col items-center justify-between  ">
            ...
            <div className={`p-12 font-bold z-10 text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)] text-center grow`}>
                <h1 className={`${isLoading ? "opacity-100" :" opacity-0 -translate-y-10 "} mb-6 text-4xl xl:text-5xl`}>Mehdi Degryse</h1>
